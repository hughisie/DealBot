...
class ScrapulaService:
    ...
    def __init__(self, api_key: str, service_name: str = "amazon_product_service"):
        ...
        self.base_url = "https://api.datapipeplatform.com"
    ...
    def _wait_for_completion(self, task_id: str, max_wait_seconds: int) -> Optional[dict]:
        ...
        while time.time() - start_time < max_wait_seconds:
            try:
                ...
                if status == "SUCCESS":
                    ...
                    logger.info(f"Scrapula task {task_id} still processing... ({elapsed}s)")
        ...
        logger.warning(f"Scrapula task {task_id} timed out after {max_wait_seconds}s")
        return None
